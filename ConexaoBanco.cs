...
namespace Livros
{
   ...
   "					 VALUES (@id , @nome, @ano , @editora)", cnx);
		...
		public DataTable GridCategoria()
		{
			SqlCommand dgvCategoria = null;
			...
			if (this.Abrirconexao())
			{
				...
				try
				{
					dgvCategoria = new SqlCommand(sql, cnx);
					SqlDataAdapter adp = new SqlDataAdapter(dgvCategoria);
		...
		#region excluir e alterar

		public bool ExcluirCategorias(int p_Codigo)
		{
			...
			if (this.Abrirconexao())
			{
				try
				{
					...
					excluircategorias.Parameters.Add(new SqlParameter("@i", p_Codigo));
		...
		public bool AlterarCategorias(int p_Codigo, string p_nome)
		{
			...
			if (this.Abrirconexao())
			{
				try
				{
					...
					alterarcategorias.Parameters.Add(new SqlParameter("@i", p_Codigo));
					alterarcategorias.Parameters.Add(new SqlParameter("@n", p_nome));
